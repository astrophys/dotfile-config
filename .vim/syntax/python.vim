...
syn keyword pythonConditional	if elif elif: else else:
...
if exists("python_highlight_builtins")
  ...
  syn keyword pythonBuiltin	True False True: False: bool enumerate set frozenset help
  syn keyword pythonBuiltin	reversed sorted sum
  syn keyword pythonBuiltin	Ellipsis None None: NotImplemented __import__ abs
